...
import { createHomeContent, getHomeContents, updateHomeContent, deleteHomeContent } from '@/hooks/dashboard/home/lib/home'

import toast from 'react-hot-toast'

import HomeSkelaton from "@/hooks/dashboard/home/HomeSkelaton"
...
export default function HomeLayout() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (selectedContent) {
                await updateHomeContent(selectedContent.id!, formData, selectedImage || undefined)
                ...
                await createHomeContent(formData, selectedImage)
    ...
    const handleDeleteConfirm = async () => {
        try {
            setIsSubmitting(true)
            await deleteHomeContent(selectedContent!.id!)
                    ...
                    <div key={content.id} className="bg-white rounded-xl overflow-hidden border border-gray-300 py-10">
                        <div className='flex flex-col md:flex-row items-center'>
                            ...
                            <div className="p-8 md:w-1/2">
                                <h3 className="text-2xl xl:text-4xl max-w-[500px] font-bold mb-4 text-[var(--primary)]">{content.title}</h3>
