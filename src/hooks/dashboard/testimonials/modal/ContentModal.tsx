...
import { ContentModalProps } from '@/hooks/dashboard/testimonials/types/testimonials';
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="bg-gray-50/50 p-6 rounded-2xl space-y-6 border border-gray-100">
                                        ...
                                        <div className="space-y-2">
                                            <label htmlFor="title" className="text-sm font-medium text-gray-700">Nama</label>
                                            <input
                                                type="text"
                                                id="title"
                                                value={formData.name}
                                        ...
                                        {/* Description Input */}
                                        <div className="space-y-2">
                                            <label htmlFor="description" className="text-sm font-medium text-gray-700">Message</label>
                                            <textarea
                                                id="description"
