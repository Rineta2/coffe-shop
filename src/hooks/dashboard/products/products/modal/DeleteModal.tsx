...
import { DeleteModalProps } from '@/hooks/dashboard/products/products/types/products';

export const DeleteModal: React.FC<DeleteModalProps> = ({ isOpen, onClose, onDelete, isSubmitting }) => {
