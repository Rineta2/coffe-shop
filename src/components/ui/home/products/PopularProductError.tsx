...
export default function PopularProductError() {
    return (
            ...
            <div className="container px-4 md:px-10 z-50">
                <div className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
                    ...
                    <h3 className="text-2xl font-bold text-[#6F4E37] mb-3">
                        Kopi Favorit Sedang Disiapkan
                    </h3>
                    <p className="text-[#8B7355] text-lg leading-relaxed">
                        Kami sedang menyiapkan daftar kopi terlaris kami dengan cita rasa terbaik.
                        Silakan kembali sebentar lagi untuk melihat pilihan kopi favorit pelanggan kami.
                    </p>
                    <div className="mt-8 flex items-center gap-2 text-[#6F4E37]">
                        ...
                        <span className="text-sm font-medium">Terima kasih telah menunggu</span>
                    </div>
                </div>
            </div>
        </section>
